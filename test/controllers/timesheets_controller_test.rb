...
class TimesheetsControllerTest < ActionController::TestCase
  ...
  test "should create timesheet" do
    assert_difference('Timesheet.count') do
      post :create, timesheet: { description: @timesheet.description, hours: @timesheet.hours, project_id: @timesheet.project_id }
    end
  ...
  test "should update timesheet" do
    patch :update, id: @timesheet, timesheet: { description: @timesheet.description, hours: @timesheet.hours, project_id: @timesheet.project_id }
    assert_redirected_to timesheet_path(assigns(:timesheet))
  end
